...
**Version 0.4.3** (`v0.4.3`) — shown in the overlay footer, which turns amber when an update is waiting. Latest release: [v0.4.3](https://github.com/CosmonautJones/ai-usage-overlays/releases/tag/v0.4.3).
...
Optional Windows installer: [AIUsageOverlaySetup.exe](https://github.com/CosmonautJones/ai-usage-overlays/releases/download/v0.4.3/AIUsageOverlaySetup.exe) from [Releases](https://github.com/CosmonautJones/ai-usage-overlays/releases) (`v0.4.3`). Once installed, the overlay updates itself: tray → **Updates** → **Check for updates** → **Install update**.
